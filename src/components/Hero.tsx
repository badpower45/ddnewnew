      ...
      <div className="bg-[#020b1c] border-b border-[#d4af37]/20 relative z-20">
        <div className="container mx-auto flex items-center h-10 overflow-hidden">
          ...
          <div className="flex items-center gap-2 px-4 h-full bg-[#d4af37]/10 border-r border-[#d4af37]/20 z-10 shrink-0">
            ...
            <span className="text-[10px] font-bold tracking-widest text-[#d4af37] uppercase">Market Live</span>
          </div>
          ...
          <div className="flex-1 overflow-hidden relative flex items-center">
                ...
                {[1, 2].map((iter) => (
                  <React.Fragment key={iter}>
                    <div className="flex items-center gap-2 text-xs">
                      ...
                      <span className="bg-green-500/20 text-green-400 px-1 rounded text-[10px]">100% FUNDED</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2 text-xs">
                      ...
                      <span className="text-[#d4af37] font-mono">SERIES A OPEN</span>
                      <span className="bg-[#d4af37]/20 text-[#d4af37] px-1 rounded text-[10px]">HOT</span>
                    </div>
                    ...
                    <div className="flex items-center gap-2 text-xs">
                      ...
                      <span className="text-white font-mono">RIYADH EXPANSION</span>
                    ...
                    <div className="flex items-center gap-2 text-xs">
                       <span className="text-gray-400 font-bold">MARKET VOL</span>
             ...
             <div className="absolute inset-y-0 right-0 w-20 bg-gradient-to-l from-[#020b1c] to-transparent z-10" />
             <div className="absolute inset-y-0 left-0 w-20 bg-gradient-to-r from-[#020b1c] to-transparent z-10" />
          </div>
        </div>
      </div>
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#d4af37]/30 bg-[#d4af37]/5 text-[#d4af37] text-xs font-bold tracking-widest uppercase mb-8">
                ...
                <span>Licensed Investment Platform</span>
              </div>
              ...
              <p className="text-gray-300 text-lg max-w-xl mb-10 leading-relaxed font-light">
                Connect with vetted high-growth franchises and startups across the Middle East. 
              ...
              <div className="flex flex-wrap items-center gap-8 text-sm text-gray-400">
                <div className="flex items-center gap-2">
                  ...
                  <span>Cross-Border Deals</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#d4af37]" />
                  <span>SAMA/CBE Compliant</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-[#d4af37]" />
            ...
            >
               {/* 1. Franchise Owner */}
               <GlassCard 
                 className="p-6 cursor-pointer group hover:bg-[#d4af37]/10 transition-all border-l-4 border-l-transparent hover:border-l-[#d4af37] hover:-translate-y-1 hover:shadow-[0_0_30px_rgba(212,175,55,0.15)]"
               ...
               >
                 ...
                 <h3 className="text-xl font-bold text-white mb-2 font-serif">Franchise Owner</h3>
                 <p className="text-sm text-gray-400 mb-6 leading-relaxed">I want to sell franchise rights or expand my brand locations.</p>
                 <div className="flex items-center text-[#d4af37] text-xs font-bold uppercase tracking-widest">
                   Start Selling <ChevronRight className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" />
                 </div>
               </GlassCard>
               ...
               >
                 ...
                 <h3 className="text-xl font-bold text-white mb-2 font-serif">Seek Funding</h3>
                 <p className="text-sm text-gray-400 mb-6 leading-relaxed">I need capital to scale my startup or existing business.</p>
                 <div className="flex items-center text-[#d4af37] text-xs font-bold uppercase tracking-widest">
                   Get Funded <ChevronRight className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" />
                 </div>
               </GlassCard>

               {/* 3. Investor (Full Width) */}
               <GlassCard 
                 className="p-8 md:col-span-2 cursor-pointer group hover:bg-[#d4af37]/10 transition-all border-l-4 border-l-transparent hover:border-l-[#d4af37] flex flex-col md:flex-row items-start md:items-center gap-8 relative overflow-hidden"
               ...
               >
                 ...
                 <div className="flex-1 relative z-10">
                   <h3 className="text-2xl font-bold text-white mb-2 font-serif">I am an Investor</h3>
                   <p className="text-sm text-gray-400 max-w-sm leading-relaxed">Looking for high-growth opportunities to diversify my portfolio with audited returns.</p>
                 </div>
                 <Button className="bg-white text-[#020b1c] hover:bg-[#d4af37] font-bold rounded-xl px-8 py-6 h-auto transition-all shadow-lg shrink-0 relative z-10 group-hover:shadow-[0_0_20px_rgba(212,175,55,0.4)]">
                   Start Investing <ChevronRight className="w-4 h-4 ml-2" />
                 </Button>
               </GlassCard>
...
function StatItem({ label, value, suffix, icon, highlight }: { label: string, value: string, suffix: string, icon: React.ReactNode, highlight?: boolean }) {
  return (
    <div className={`relative p-6 rounded-2xl border transition-all duration-500 group hover:-translate-y-2 ${highlight ? 'bg-gradient-to-b from-[#d4af37]/10 to-[#d4af37]/5 border-[#d4af37]/30 shadow-[0_0_30px_rgba(212,175,55,0.1)]' : 'bg-white/[0.02] border-white/5 hover:border-[#d4af37]/20 hover:shadow-2xl'}`}>
      <div className="flex items-center justify-between mb-4 opacity-80 group-hover:opacity-100 transition-opacity">
        ...
        {highlight && <div className="text-[10px] font-bold bg-[#d4af37] text-[#020b1c] px-3 py-1 rounded-full shadow-lg">TOP TIER</div>}
      </div>
      <div className="text-3xl md:text-5xl font-serif font-bold text-white mb-2 tracking-tight group-hover:scale-105 transition-transform origin-left">
        {value}<span className={`text-lg md:text-2xl font-sans font-medium ml-1 ${highlight ? 'text-[#d4af37]' : 'text-gray-500 group-hover:text-[#d4af37] transition-colors'}`}>{suffix}</span>
      </div>
